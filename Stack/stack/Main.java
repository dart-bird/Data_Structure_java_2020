...
public class Main {
    ...
    /*
     * 4) 보너스 operation (괄호 체크) - 구현하지 않아도 A 받는데 문제 없음 - 구현할 때 주석 풀고 구현하면 됨 - 최종 구현에
     * 실패하면 꼭 주석처리 - checkMatching(): 문자열을 입력받아서 해당 문자열이 괄호가 제대로 닫혀있는 지를 확인해주는 함수 구현
     * - 문자열은 괄호로만 이루어져있다고 가정 - ex) (()()) >> True - ex2) (()(())()))() >> False
     */
    ...
    public static void main(String[] args) {
        ...
        /*
         * Stack 전체 operation test - 여기는 구현 성공 여부를 가르쳐 주지 않습니다. - 예제 출력을 주석으로 달아놓았으니
         * 참고하시기 바랍니다.
         */
        ...
        // System.out.println(checkMatching("(((((()))))")); // false
        // System.out.println(checkMatching("()(())((()))()()(())((()))(())((((()))))"));
        // // true
    }
